...
export const AuthHeader = ({ isSignUpPage }: AuthHeaderProps) => {
  return (
    <div className="mb-[48px]">
      <h2 className="mb-3 font-nunito text-center text-[32px] font-bold leading-[135%] text-text-primary">
        {isSignUpPage ? "Вітаємо!" : "Раді вас знову бачити! "}
      </h2>
      <p className="font-nunito text-center text-[16px] font-medium leading-[135%] text-text-gray">
        {isSignUpPage
