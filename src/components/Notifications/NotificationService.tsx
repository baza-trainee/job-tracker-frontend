...
export const notifySuccess = (message: string, title?: string): void => {
  toast.success(<NotificationCustom title={title} message={message} />, {
    className:
      "bg-backgroundTertiary w-fit border-t-transparent border-[1px] border-solid border-color7 rounded-tl-[0] rounded-br-[12px] rounded-tr-[0] rounded-bl-[12px] min-h-9 h-9",
