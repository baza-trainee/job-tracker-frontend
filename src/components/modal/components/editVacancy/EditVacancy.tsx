...
const EditVacancy = () => {
    ...
    const onSubmit: SubmitHandler<z.infer<typeof EditVacancySchema>> = async (formData) => {
        try {
                        ...
                        <div className="flex w-[445px] flex-col justify-between gap-4">
                            <div className="flex flex-col gap-4 pt-2">
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    <span onClick={() => {}} className="flex flex-row gap-3 -ml-[2px] hover:cursor-pointer"><Icon id={"plus"} className="ml-3 h-6 w-6" /> Додати етап</span>
                                </div>
                            </div>
                        </div>
                    </div>
