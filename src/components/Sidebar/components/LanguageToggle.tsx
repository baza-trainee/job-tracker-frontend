  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          "flex overflow-hidden px-3 py-[5px] text-textBlack hover:text-iconHover disabled:hover:text-iconHover dark:hover:text-iconHover md:px-2 md:py-1",
          {
      ...
      <button
        ...
        onClick={() => i18n.changeLanguage(isUA ? LOCALS.EN : LOCALS.UA)}
        className={cn(
          "flex justify-end overflow-hidden px-2 py-[5px] hover:text-iconHover disabled:hover:text-iconHover dark:hover:text-iconHover md:py-1",
