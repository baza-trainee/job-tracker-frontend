...
const StatisticsPanelSkeleton = () => {
  return (
    <div className="flex w-full flex-wrap gap-y-2 md:justify-between">
      <div className="flex flex-wrap gap-x-3 gap-y-2 md:gap-2 xl:gap-3 2xl:gap-5 2xl:self-start 3xl:gap-8 mdOnly:w-1/2">
