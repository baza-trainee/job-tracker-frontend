            ...
            <span
              ...
              className={cn(
                ...
                (name === "hours" || name === "minutes") &&
                  "absolute top-[130%] z-10 w-[220px] rounded-md bg-whiteColor pb-2 pl-4 pt-1 text-start text-xs text-redColor md:top-[120%] md:w-[250px] md:text-sm xl:top-[110%] xl:w-[280px] 2xl:text-base",
